defmodule Adventofcode2018.Day07TheSumOfItsPartsP2 do
  ...
  def calc_duration(vs, g, ig, ini_delay, max_workers, working_times \\ %{}, total_duration \\ 0)
  ...
  def calc_duration(vs, g, invg, ini_delay, max_workers, working_times, total_duration) do
    {working_times, vs} =
      if Map.size(working_times) < max_workers do
