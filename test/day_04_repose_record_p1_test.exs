defmodule Adventofcode2018.Day04ReposeRecordP1Test do
  ...
  describe "parse_begins/1" do
    test "return struct when success" do
      assert %Adventofcode2018.GuardBegins{id: 617} = parse_begins "[1518-09-27 00:02] Guard #617 begins shift"
    end
  end

  describe "parse_sleeps/1" do
    test "return struct when success" do
      assert %Adventofcode2018.GuardAsleep{min: 5} = parse_sleeps "[1518-11-11 00:05] falls asleep"
    end
  end
  ...
  describe "aggr_input/2" do
    test "valid shift" do
      assert %{
        cur_shift: %{id: 1, sleeps: [25..29, 1..9]}} =
        [
